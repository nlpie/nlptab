...
/**
 * An exception throw when analysis is given an invalid configuration.
 */
public class AnalysisConfigurationException extends Exception {
    ...
    public AnalysisConfigurationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
